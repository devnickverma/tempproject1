...
from adapters.schemas.tools_schema import ToolsSchema
from frames.frames import AudioRawFrame, Frame
...
class OpenAILLMContext:
    ...
    def to_standard_messages(self, obj) -> list:
        ...
        OpenAI's format is our standard format throughout  This function
