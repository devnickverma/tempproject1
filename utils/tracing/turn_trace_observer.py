...
from observers.base_observer import BaseObserver, FramePushed
from observers.turn_tracking_observer import TurnTrackingObserver
from utils.tracing.conversation_context_provider import ConversationContextProvider
from utils.tracing.setup import is_tracing_available
from utils.tracing.turn_context_provider import TurnContextProvider
...
class TurnTraceObserver(BaseObserver):
    ...
    def __init__(
        ...
        self._tracer = trace.get_tracer("turn") if is_tracing_available() else None
